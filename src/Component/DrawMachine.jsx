...
const DrawMachine = () => {
  ...
  const startDraw = () => {
    ...
    const duration = 10000; // Duration of rolling animation
    const intervalSpeed = 100; // Speed of number change during rolling
    const totalIntervals = duration / intervalSpeed;
    ...
    const interval = setInterval(() => {
      if (counter < totalIntervals) {
        ...
        clearInterval(interval);
        fetchLuckyNumber(); // Fetch the actual number after rolling
      }
    }, intervalSpeed);
  };
